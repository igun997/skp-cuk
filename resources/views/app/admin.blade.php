...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="https://material.io/tools/icons/?style=baseline">
      ...
      <div class="header py-4" style="background-color: #394F14">
        <div class="container">
          <div class="d-flex">
            ...
            <div class="user-box">
            <img src="http://103.114.76.99/skp_v2/public/assets/images/logo_skp.png" alt="" style="width:180px;">
            </div>

            <div class="d-flex order-lg-2 ml-auto">
              <li class="dropdown notification-list">
                <a class="nav-link dropdown-toggle nav-user" data-toggle="dropdown" href="index.html#" role="button" ria-haspopup="false" aria-expanded="true">
                  ...
                  <span class="ml-2 d-none d-lg-block">
                    <span class="text-default" style="color: #fff !important">Admin</span>
          ...
          <div class="row align-items-center">
            ...
            <div class="col-lg order-lg-first">
              <ul class="nav nav-tabs border-0 flex-column flex-lg-row" style="color: #00FF00;">
                <li class="nav-item">
                  <a href="{{route("admin")}}" class="nav-link"><i class="fe fe-home"></i> Home</a>
                </li>
                <li class="nav-item">
                  <a href="javascript:void(0)" class="nav-link" data-toggle="dropdown"><i class="fe fe-box"></i> Data Master</a>
                  <div class="dropdown-menu dropdown-menu-arrow">
                    <a href="{{route("admin.golongan.index")}}" class="dropdown-item ">Data Golongan</a>
                    <a href="{{route("admin.jabatan.index")}}" class="dropdown-item ">Data Jabatan</a>
                    <a href="{{route("admin.unit.index")}}" class="dropdown-item ">Data Sub. Bagian</a>
                    <a href="{{route("admin.pegawai.index")}}" class="dropdown-item ">Data Pegawai</a>
                  </div>
                </li>
                <li class="nav-item dropdown">
                  <a href="javascript:void(0)" class="nav-link" data-toggle="dropdown"><i class="fe fe-file"></i> SKP</a>
                  <div class="dropdown-menu dropdown-menu-arrow">
                    <a href="{{route("admin.kegiatan.index")}}" class="dropdown-item ">Uraian kegiatan</a>
                    <a href="{{route("admin.skp.index")}}" class="dropdown-item ">Sasaran Kinerja </a>
                  </div>
                </li>
                <li class="nav-item">
                  <a href="{{route("admin.ranking.index")}}" class="nav-link"><i class="fe fe-edit"></i> Perangkingan Pegawai</a>
                </li>
                <li class="nav-item dropdown">
                  <a href="javascript:void(0)" class="nav-link" data-toggle="dropdown"><i class="fe fe-box"></i> Laporan</a>
                  <div class="dropdown-menu dropdown-menu-arrow">
                    <a href="{{route("admin.hasil.index")}}" class="dropdown-item ">Prestasi Kinerja</a>
                  </div>
                </li>
              </ul>
            </div>
